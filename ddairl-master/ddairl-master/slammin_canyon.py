...
def main():
    ...
    cross_entropy_q_brain = CrossEntropyQBrain(SAFE_REWARD, CRASH_REWARD, ADVANCES_LEARNING_INTERVAL, DISCOUNT, \
        NUMBER_ACTIONS, STEP_SIZE, RANDOM_MOVE_PROBABILITY, NUMBER_ROAD_SECTIONS_IN_Q_VALUES)
    game.start(cross_entropy_q_brain)
