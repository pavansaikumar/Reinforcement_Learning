    ...
    def __update_qvalues(self, action, reward, recent_road_states):
        ...
        for current_state in learning_states:
            ...
            if (qvalues_tuple in self.latest_qvalues):
                qvalue = self.__bellmans_equation(self.latest_qvalues[qvalues_tuple], reward, discount, self.max_qvalues[qvalues_tuple])
            ...
            discount_power -=  1 ## Earlier states are more important than the present one
